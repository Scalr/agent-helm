...
If an Agent Pool Token is revoked (e.g. from the Scalr Agent Pool tokens page), all associated Agent Session Tokens are revoked. Subsequent API calls return `401`, which causes the agents to shut down.
