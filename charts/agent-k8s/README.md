...
This requires a dedicated cluster or a separate node pool for agent installation.

Otherwise, it may scale across a large number of nodes, spawning excessive number of idle workers.
