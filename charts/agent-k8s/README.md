...
This mode aims to provide more cloud-native deployment option by removing hostPath, simplify maintenance by eliminating DaemonSet-based persistent workers, and improve robustness by deploying individual, fully isolated, stateless per-run workers.
