...
| agent.container_task_image_registry | string | `""` | The OCI image registry configuration for legacy software-specific Docker images: `scalr/terraform`, `scalr/opentofu`, `openpolicyagent/opa`, `infracost/infracost` and `bridgecrew/checkov`. If the registry ends with a trailing slash, it will be appended to the original namespace/image-name. Otherwise, the namespace will be erased. Examples:   - gcr.io/my/org/ + scalr/runner:0.0.1 => gcr.io/my/org/scalr/runner:0.0.1   - gcr.io/my/org + scalr/runner:0.0.1 => gcr.io/my/org/runner:0.0.1 |
