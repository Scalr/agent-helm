...
![Version: 0.5.72](https://img.shields.io/badge/Version-0.5.72-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.65.1](https://img.shields.io/badge/AppVersion-0.65.1-informational?style=flat-square)
...
> [!NOTE]
> To obtain an mTLS certificate, generate the private key locally and submit the CSR to Scalr via the Agent Pool UI when registering a new agent, or via the *Certificates* tab on the Agent Pool page to receive a signed certificate for your private key. The private key never leaves the operator host.
> See the [Scalr mTLS documentation](https://docs.scalr.io/docs/mtls) for details.

Generate an EC P-256 private key and CSR, then submit the CSR to Scalr to receive a signed certificate:
